...
void JX11LookAndFeel::setColors()
{
    // Slider colors
    setColour(juce::Slider::backgroundColourId, juce::Colour::fromString("ff97cbf8"));
    setColour(juce::Slider::thumbColourId, juce::Colour::fromString("ff013779"));
    setColour(juce::Slider::textBoxTextColourId, juce::Colour::fromString("ff121255"));
    setColour(juce::Slider::trackColourId, juce::Colour::fromString("ff2060a7"));
    setColour(juce::Slider::rotarySliderOutlineColourId, juce::Colour::fromString("ffcfcfdf"));

    // Label colors
    setColour(juce::Label::ColourIds::textColourId, juce::Colour::fromString("ffeff1f1"));
    setColour(juce::Label::ColourIds::backgroundColourId, juce::Colour::fromString("ff153c69"));
    ...
    setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colour::fromString("ff42bbfc"));
    setColour(juce::TextButton::ColourIds::textColourOnId, juce::Colour::fromString("ffeff1f1"));
...
juce::Rectangle<int> JX11LookAndFeel::getTooltipBounds(const juce::String& /* tipText */,
...
void JX11LookAndFeel::drawTooltip(juce::Graphics& g, const juce::String& text, int width, int height)
{
 ...
 */
void JX11LookAndFeel::drawLinearSlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
                                       ...
                                       juce::Slider& slider)
{
    ...
    g.setFont(getDefaultFont(20.f));
    g.setColour(findColour(juce::Label::ColourIds::backgroundColourId));
    g.drawText(text, text_bounds, juce::Justification::centred);
}

void JX11LookAndFeel::drawRotarySlider(juce::Graphics& g, int /* x */, const int y, const int width, const int height,
...
void JX11LookAndFeel::drawComboBox(juce::Graphics& g, const int width, const int height, bool /* isButtonDown */,
...
void JX11LookAndFeel::positionComboBoxText(juce::ComboBox& box, juce::Label& label)
{
    label.setBounds(juce::Rectangle<int>(0, 0, box.getWidth(), box.getHeight()).reduced(3, 1));
    label.setFont(getDefaultFont(18.f));
    label.setJustificationType(juce::Justification::centred);
}

void JX11LookAndFeel::drawPopupMenuBackground(juce::Graphics& g, int width, int height)
{
...
void JX11LookAndFeel::drawPopupMenuItem(juce::Graphics& g, const juce::Rectangle<int>& area,
